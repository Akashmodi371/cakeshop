            ...
            {loading ? (
              Array.from({ length: 8 }).map((_, i) => (
                <tr key={i} className="border-b border-gray-50">
                  ...
                  <td className="px-4 py-3 hidden md:table-cell"><div className="skeleton h-5 w-20 rounded-full" /></td>
                  <td className="px-4 py-3 hidden lg:table-cell"><div className="skeleton h-4 w-12 rounded" /></td>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-1 mt-0.5">
                        ...
                        <span className="text-[10px] text-gray-400">{cake.image_count} imgs</span>
                      </div>
                    </div>
                  </div>
                </td>
                <td className="px-4 py-3 hidden sm:table-cell">
                  <span className="text-xs text-gray-500">{cake.category_name || '—'}</span>
                </td>
                <td className="px-4 py-3">
